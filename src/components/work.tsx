...
const mockdata = [
  {
    company: "Majako",
    title: "Frontend-developer Graphic designer || 2024-2025",
    description:
      "As a Frontend developer at  Majako, Got to contribute on multiple different projects and websites, working mostly in React-native, Adobe suite and figma.",
